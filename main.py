...
def main(filename: str, output_folder):
    ...
    while cap.isOpened():
        ...
        if frame_exists:
            ...
            _logger.debug(f"THRESHOLD_OF_IMAGE_PRC diff={round(diff_percentage_img, 2)}%, threshold={THRESHOLD_OF_IMAGE_PRC}%, time={time_form}")
