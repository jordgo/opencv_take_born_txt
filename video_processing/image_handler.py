...
class ImageHandler:
    def __init__(self, image: np.ndarray, frame_time: str, is_first: bool, config: list):
    ...
    def process_img(self):
        ...
        page_type: page_templates.BasePageType = page_templates.get_page_type(w_screen, h_screen, all_rectangles, self.config)
        ...
        def get_header_rectangles_with_text() -> List[data_cls.RectangleData]:
            return get_img_text_by_contours(self.original_image, header_rectangles)
        header_rectangles_with_text = get_header_rectangles_with_text() if body_left_side_rect_with_text else []
